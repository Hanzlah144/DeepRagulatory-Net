...
class Predictor:
    ...
    def __init__(self, model_file="Model_Files/calibrated_catboost_site_type_model.pkl",
                 encoder_file="Model_Files/label_encoder.pkl",
                 scaler_file="Model_Files/robust_scaler.pkl"):
        self.logger = logging.getLogger()
        # Load model (joblib expected)
    ...
    def _prepare(self, features):
        """Select feature columns and apply scaler if present. Accepts DataFrame or array-like."""
        import pandas as pd
        import numpy as np
    ...
    def predict(self, features):
        ...
        # Map back to labels if encoder available
